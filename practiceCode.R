...
token <- "DrYywYMAkH9vFUHzBOQ1lcASR"
covid_cases <- read.socrata("https://soda.demo.socrata.com/resource/4334-bgaj.csv", app_token = token)
...
df <- read.socrata(
  ...
  app_token = "DrYywYMAkH9vFUHzBOQ1lcASR")

countyData<- fromJSON("https://api.covidactnow.org/v2/states.json?apiKey=b85ff1e2d70f42238d88916f7dffa95d")
